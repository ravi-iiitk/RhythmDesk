 ...
 */
function validatePostponeOptions(options, fieldPrefix, errors) {
 ...
 */
function validateTransitionConfig(config, fieldPrefix, errors) {
    if (!config) {
 ...
 */
function validateBreakConfig(config, fieldPrefix, cycleMinutes, otherBreakEveryMinutes, isLongBreak, errors) {
    if (!config) {
 ...
 */
function validateFlowSteps(flowSteps, errors) {
