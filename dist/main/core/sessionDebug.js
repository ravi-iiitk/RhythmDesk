...
exports.normalizeFlowIndex = normalizeFlowIndex;
exports.validateRuntimeState = validateRuntimeState;
exports.attemptSafeRecovery = attemptSafeRecovery;
exports.createDebugSnapshot = createDebugSnapshot;
...
function logSessionEvent(data) {
    ...
    if (infoEvents.includes(event)) {
        logger_1.default.info('SessionDebug', logLine);
    }
    else {
        logger_1.default.debug('SessionDebug', logLine);
    }
 ...
 */
function normalizeFlowIndex(index, flowStepsLength) {
 ...
 */
function validateRuntimeState(state, schedule, nextPhase) {
    const errors = [];
    const warnings = [];
    ...
    if (state.isPostponed && state.postponedPhase) {
        ...
        const breakPhases = ['short-break', 'long-break'];
        ...
        const workPhases = ['sit', 'stand', 'sit-to-stand-transition', 'stand-to-sit-transition'];
 ...
 */
function attemptSafeRecovery(state, schedule) {
 ...
 */
function createDebugSnapshot(state, schedule, nextPhase, thenPhase) {
...
//# sourceMappingURL=sessionDebug.js.map